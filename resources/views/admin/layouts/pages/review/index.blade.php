        ...
        <div class="col-lg-12 col-md-12 col-sm-12 mt-4">
            <div class="card">
                <div class="card-header">
                    <h4> All Reviews<span><a href="{{ route('review.create') }}" class="btn btn-primary text-white text-uppercase text-bold right">
                        + Add Review
                   </a></span></h4>
                </div>
                <div class="body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('review.edit', $review->id) }}" class="btn btn-warning btn-sm"> <i class="material-icons text-white">edit</i></a>
