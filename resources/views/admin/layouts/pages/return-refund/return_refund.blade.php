...
@section('title', 'Return Refund Page')
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 mt-4">
            <div class="card">
                <div class="card-header">
                    <h4 style="display: inline-block"> Update Return Refund</h4>

                </div>
                <div class="body">
                    <form action="{{ route('return_refund.update',$returnRefund->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row clearfix">
                        <div class="col-md-12 col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea id="ckeditor" name="content">{!! $returnRefund->content !!}</textarea>
                            </div>
